...
@router.get("/{budget_id}", response_model=BudgetResponse, summary="Get budget entry by ID")
...
@router.put("/{budget_id}", response_model=BudgetResponse, summary="Update a budget entry")
...
@router.delete("/{budget_id}", status_code=204, summary="Delete a budget entry")
