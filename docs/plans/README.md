...
| [audit-production-readiness](archive/audit-production-readiness.md) | archived | Audit — P0/P2 + most P1 done; P1.7 → import-bank-profiles |
| [audit-planned-vs-code](audit-planned-vs-code.md) | draft | Audit — verification wave / gap-closing still open |
